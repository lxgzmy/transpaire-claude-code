...
- **Build-contract figures and legal statements** (CD-5.4). The fill itself is
  ...
  a person. In PRODUCTION with no MCR-approved blank the whole contract stays
  a data sheet.
